import { Alert, Box, Button, FormControl, Grid, Select, TextField, Typography } from "@mui/material";
...
type Props = {
  initial?: Category;
  onSubmit: (category: Category, file?: File) => Promise<ActionResult>;
};
...
const CategoryForm: React.FC<Props> = ({ initial = emptyCategory, onSubmit }) => {
